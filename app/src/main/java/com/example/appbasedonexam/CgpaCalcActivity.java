...
public class CgpaCalcActivity extends AppCompatActivity {
    ...
    int g1 = 4, g2 = 4, g3 = 4, g4 = 4, g5 = 4, g6 = 4, g7 = 4, g8 = 4 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if ((sg1 > 4.0) || sg2 > 4.0 || sg3 > 4.0 || sg4 > 4.0 || sg5 > 4.0 || sg6 > 4.0 || sg7 > 4.0 || sg8 > 4.0) {
                    Toast.makeText(getApplicationContext(), " Invalid SGPA", Toast.LENGTH_SHORT).show();
                } else {

                    Intent i3 = new Intent(getApplicationContext(), cgpa_result.class);
